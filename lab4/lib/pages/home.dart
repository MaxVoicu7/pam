...
import 'package:lab2/controllers/categories_controller.dart';
import 'package:lab2/controllers/doctors_controller.dart';
import 'package:lab2/controllers/main_card_controller.dart';
import 'package:lab2/controllers/medical_centers_controller.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final MainCardController mainCardController = Get.put(MainCardController());
    final CategoryController categoryController = Get.put(CategoryController());
    final MedicalCenterController medicalCentersController =
          ...
          child: Column(
            children: [
              ...
              Obx(() {
                ...
                return MainCardsCarousel();
              }),
              Obx(() {
                if (categoryController.categories.isEmpty) {
                  return CircularProgressIndicator();
                }
                return Categories(categories: categoryController.categories);
              }),
              Obx(() {
                if (medicalCentersController.medicalCenters.isEmpty) {
                  return CircularProgressIndicator();
                }
                return MedicalCentersWidget(
                    medicalCenters: medicalCentersController.medicalCenters);
              }),
              Obx(() {
                if (doctorController.doctors.isEmpty) {
                  return CircularProgressIndicator();
                }
                return DoctorsWidget(doctors: doctorController.doctors);
              })
            ],
          ),
        ));
...
class Categories extends StatelessWidget {
  ...
  List<List<CategoryModel>> _chunkCategories(int chunkSize) {
    List<List<CategoryModel>> chunks = [];
